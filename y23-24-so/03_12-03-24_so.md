...
2. [Progettazione di sistemi operativi](#progettazione-di-sistemi-operativi)
    ...
    2. [Personal computer](#personal-computers)
    3. [Palmari / Smartphones](#palmarismartphone)
    4. [Sistemi embedded](#sistemi-integratiembedded)
    5. [Real-Time](#realtime)
3. [Strutture di sistemi operativi](#strutture-di-sistemi-operativi)
    1. [Struttura monolitica](#struttura-monolitica)
    2. [Struttura a strati/livelli](#struttura-a-strati--a-livelli)
    3. [Microkernel](#microkernel)
    4. [Struttura a moduli](#struttura-a-moduli)
    5. [Macchine Virtuali](#macchine-virtuali)
        1. [Simulazione](#simulazione)
        2. [Para-virtualizzazione](#para-virtualizzazione)
